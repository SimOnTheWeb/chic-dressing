...
<div class="main-container">
		...
		while ( have_posts() ) :
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
				...
				<div class="post-media">
					<a href="<?php echo esc_url( get_permalink() ); ?>" title="Lire l'article complet" aria-label="Lire l'article complet"></a>
	...
	echo '</ul>';
	echo '<p class="text-center"><a class="chic-bouton" href="#leblog">Voir tous les articles</a></p>';
